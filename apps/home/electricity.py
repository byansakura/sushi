...
def get_predicted_kwh():
    # load the data
    file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "CRCS.csv"))
    ...
    df = df[['KwH', 'MaxTemperature', 'MinTemperature']]
    ...
    predicted_kwh = pred_df['KwH'].reset_index().to_dict('records')
